...
final class HiveStatusView {
    ...
    static ResourceLocation icon(int status) {
        ...
        if (error == null) {
            ...
            return ResourceLocation.fromNamespaceAndPath("forestry", "textures/forestry/atlas/gui/errors/" + name + ".png");
        }
        String path = error.getSprite().getPath();
        return ResourceLocation.fromNamespaceAndPath(error.getSprite().getNamespace(),
