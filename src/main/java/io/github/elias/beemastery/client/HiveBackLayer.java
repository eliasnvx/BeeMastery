...
public class HiveBackLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    /** One model per tier; registered as standalone models in {@link PortableHiveClient}. */
    ...
    private static ModelResourceLocation model(String name) {
        return ModelResourceLocation.standalone(ResourceLocation.fromNamespaceAndPath(ForestryExtras.MOD_ID, "block/" + name));
    }
