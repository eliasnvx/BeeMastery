 ...
 * modpacks ship defaults in {@code defaultconfigs/}); Forge syncs it to joining clients, so
 * tooltips show the server's values. {@link #CLIENT}: per-player display options
 * ({@code config/beemastery-client.toml}).
 *
...
public final class BeeMasteryConfig {
    ...
    public static final class Server {
        private final ForgeConfigSpec.DoubleValue[] tierSpeed = new ForgeConfigSpec.DoubleValue[HiveTier.VALUES.length];
        private final ForgeConfigSpec.BooleanValue ownHiveProtection;
        private final ForgeConfigSpec.DoubleValue boosterMultiplier;
        private final ForgeConfigSpec.DoubleValue longevityAging;
        private final ForgeConfigSpec.DoubleValue mutagenMultiplier;
        private final ForgeConfigSpec.IntValue collectorInterval;
        private final ForgeConfigSpec.BooleanValue lanternLight;
    ...
    public static final class Client {
        ...
        private final ForgeConfigSpec.BooleanValue showHud;
        private final ForgeConfigSpec.EnumValue<Corner> hudCorner;
        private final ForgeConfigSpec.BooleanValue beeParticles;
