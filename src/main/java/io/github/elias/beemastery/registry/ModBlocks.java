...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> WITHERIA_BLOCK = register("witheria_block",
        () -> new Block(BlockBehaviour.Properties.of()
            .strength(4.5f, 5.5f)
            .lightLevel(state -> 4)
            .requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Item> WITHERIA_BLOCK_ITEM = registerBlockItem("witheria_block", WITHERIA_BLOCK);
